...
LDFLAGS += $(shell pkg-config --libs gtkmm-3.0) -lstdc++
endif
...
# Agrego directorios del proyecto
CXXFLAGS += -I./Common -I./Server -I./Client
...
clean:
	$(RM) -fv $(o_client_files) $(o_server_files) $(target)
